...
var word_bank = {
  ...
  cookies_modal_text:
    "Con el fin de ofrecerte la información más relevante y un rendimiento óptimo del sistema, utilizamos cookies que recopilan información de tu actividad de juego.",

  sign_in: "Iniciar sesión",
  sign_up: "Registrarse",
  signin_error: "El usuario no existe",
  signup_error:
    "Ha habido un error al registrarte. Por favor, envía este error a " +
    admin_email +
    " o inténtalo de nuevo más tarde.",
  email_yes_user_no_error: "Este correo electrónico ya ha sido utilizado",
  email_yes_user_yes_error: "El usuario ya existe",
  user: "Usuario",
  password: "Contraseña",
  ...
  crypto_donation_text:
    "Por favor, envíe su donación en criptomonedas a las siguientes direcciones. Una vez enviada la donación, puede tomar algún tiempo para confirmarse en la red de blockchain.",
  paypal_donation_title: "Donar a través de PayPal",
  paypal_donation_text:
    "Por favor, utilice los siguientes enlaces para hacer una donación a través de PayPal. Una vez completada la donación, puede tomar algún tiempo para procesarse.",
  bank_donation_title: "Donar a través de Transferencia Bancaria",
  bank_donation_text:
    "Por favor, envíe su donación a la siguiente cuenta bancaria. Una vez transferida la donación, puede tomar algún tiempo para reflejarse en la cuenta.",
  ...
  no_money:
    "No tienes suficientes zanahorias. Puedes comprarlas en el mercado.",
  ...
  forgot_password_text:
    "Por favor, ingresa la dirección de correo electrónico utilizada para registrarte. Te enviaremos tu nueva contraseña a esa dirección.",
  send: "Enviar",
  email_send_mailtrap:
    "El correo electrónico ha sido enviado. Verifique su cuenta de Mailtrap.",
  ...
  empty_input_agree:
    "No has aceptado los Términos y condiciones y la Política de privacidad",
  ...
  play: "Jugar",
  play_whack_a_rabbit:
    "¡Juega a Whack a Rabbit para conseguir zanahorias gratis!",
  ...
  change: "Cambiar",
  profile_grey:
    "Para tener esta imagen, necesitas tener más de 1000 zanahorias",
  ...
  error_charge:
    "Lo sentimos, pero no podemos cobrarte debido a un error por nuestra parte. Repararemos este error lo antes posible.",
  ...
  createNewCustomer_error: "Error al crear un nuevo cliente.",
  submit: "Enviar",
  pay: "Pago",
  ...
  not_enough_money_withdrawal:
    "No tienes suficiente dinero para hacer un retiro.",
  ...
  // Keno
  keno_instructions:
    "Elige hasta 10 números en Keno o selecciona 'Selección rápida' (elegirá aleatoriamente hasta 10 números en Keno para ti)",
  ...
  theme_red_light: "Tema rojo claro",
  theme_red_dark: "Tema rojo oscuro",
  //401
  page_not_found_text:
    "Lo siento, la página que busca no existe. Es posible que se haya movido o eliminado, o que haya ingresado incorrectamente la URL.",
};
