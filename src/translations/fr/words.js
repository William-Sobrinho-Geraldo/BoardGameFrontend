...
var word_bank = {
  ...
  no_career:
    "Aucun poste disponible. Mais n'hésitez pas à nous envoyer votre CV.",

  cookies_modal_title: "Notification de cookies",
  cookies_modal_text:
    "Afin de vous offrir les informations les plus pertinentes et des performances système optimales, nous utilisons des cookies qui collectent des informations sur votre activité de jeu.",

  sign_in: "Se connecter",
  sign_up: "S'inscrire",
  signin_error: "L'utilisateur n'existe pas",
  signup_error:
    "Il y a eu une erreur lors de votre inscription. Veuillez envoyer cette erreur à " +
    admin_email +
  ...
  crypto_donation_text:
    "Veuillez envoyer votre don en cryptomonnaie aux adresses suivantes. Une fois le don envoyé, il peut falloir un certain temps pour qu'il soit confirmé sur le réseau blockchain.",
  paypal_donation_title: "Donner via PayPal",
  paypal_donation_text:
    "Veuillez utiliser les liens suivants pour faire un don via PayPal. Une fois le don terminé, il peut falloir un certain temps pour le traiter.",
  bank_donation_title: "Donner via Virement Bancaire",
  bank_donation_text:
    "Veuillez envoyer votre don au compte bancaire suivant. Une fois le don transféré, il peut falloir un certain temps pour qu'il soit reflété sur le compte.",
  ...
  no_money:
    "Vous n'avez pas assez de carottes. Vous pouvez les acheter sur le marché.",
  no_payment_methods: "Aucun moyen de paiement disponible pour le moment",
  no_cart: "Le panier est vide",
  no_history: "Aucun historique",
  no_jobs:
    "Aucun poste disponible pour le moment. Mais n'hésitez pas à nous envoyer votre CV.",
  ...
  forgot_password_text:
    "Veuillez entrer l'adresse e-mail utilisée lors de l'inscription. Nous vous enverrons votre nouveau mot de passe à cette adresse.",
  send: "Envoyer",
  ...
  empty_input_agree:
    "Vous n'avez pas accepté les conditions générales d'utilisation et la politique de confidentialité",
  ...
  play: "Jouer",
  play_whack_a_rabbit:
    "Jouez à Whack a Rabbit pour obtenir des carottes gratuites !",
  ...
  change: "Changer",
  pprofile_grey:
    "Pour avoir cette photo, vous devez avoir plus de 1000 carottes",
  ...
  error_charge:
    "Nous sommes désolés, mais nous ne pouvons pas vous facturer en raison d'une erreur de notre part. Nous réparerons cette erreur dès que possible.",
  ...
  not_enough_money_withdrawal:
    "Vous n'avez pas assez d'argent pour effectuer un retrait.",
  ...
  // Keno
  keno_instructions:
    "Choisissez jusqu'à 10 spots Keno ou choisissez le choix rapide (il choisira au hasard jusqu'à 10 spots Keno pour vous)",
  ...
  theme_red_light: "Thème rouge clair",
  theme_red_dark: "Thème rouge foncé",
  //401
  page_not_found_text:
    "Désolé, la page que vous recherchez n'existe pas. Elle a peut-être été déplacée ou supprimée, ou vous avez peut-être saisi incorrectement l'URL.",
};
