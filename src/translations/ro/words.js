...
var word_bank = {
  ...
  no_career:
    "Nu există joburi disponibile. Puteți totuși să ne trimiteți CV-ul dumneavoastră.",

  cookies_modal_title: "Notificări de cookies",
  cookies_modal_text:
    "Pentru a vă oferi cele mai relevante informații și pentru o performanță optimă a sistemului, noi folosim cookies pentru a colecta informații din activitatea dumneavoastră.",

  sign_in: "Logare",
  sign_up: "Înregistrare",
  signin_error: "User-ul nu există",
  signup_error:
    "A apărut o eroare la înregistrare. Vă rugăm să trimiteți această eroare la " +
    admin_email +
    " sau încercați din nou mai târziu.",
  ...
  crypto_donation_text:
    "Vă rugăm să trimiteți donația dvs. în criptomonedă la următoarele adrese. Odată ce donația este trimisă, ar putea dura ceva timp până când este confirmată în rețeaua blockchain.",
  paypal_donation_title: "Donați prin PayPal",
  paypal_donation_text:
    "Vă rugăm să utilizați următoarele linkuri pentru a face o donație prin PayPal. Odată ce donația este finalizată, ar putea dura ceva timp pentru a fi procesată.",
  bank_donation_title: "Donați prin Transfer Bancar",
  bank_donation_text:
    "Vă rugăm să trimiteți donația dvs. la următorul cont bancar. Odată ce donația este transferată, ar putea dura ceva timp până când este reflectată în cont.",
  ...
  no_jobs:
    "Nu există job-uri disponibile. Puteți să ne trimiteți CV-ul dumneavoastră pe email.",
  ...
  forgot_password_text:
    "Introdu adresa ta de email cu care te-ai înregistrat. Noi îți vom trimite parola nouă pe această adresă.",
  send: "Trimite",
  email_send_mailtrap:
    "E-mailul a fost trimis. Verificați contul dvs. Mailtrap.",
  ...
  empty_input_agree:
    "Nu ai fost de acord cu Termenii și condițiile și Politicile de confidențialitate",
  ...
  change: "Schimbă",
  profile_grey:
    "Pentru a avea această poză trebuie să ai peste 1000 de morcovi",
  ...
  error_charge:
    "Ne pare rău, dar nu putem onora comanda din motive tehnice. Vom repara eroarea cât de curând posibil.",
  ...
  not_enough_money_withdrawal:
    "Nu ai suficienți bani pentru a face o retragere.",
  ...
  // keno
  keno_instructions:
    "Alege până la 10 Keno Spots sau alege Quick Pick (va alege maxim 10 Keno Spots aleatoare)",
