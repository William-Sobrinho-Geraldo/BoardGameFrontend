...
var word_bank = {
  ...
  cookies_modal_text:
    "Per offrirti le informazioni più pertinenti e per una prestazione ottimale del sistema, utilizziamo i cookie che raccolgono informazioni dalla tua attività di gioco.",

  sign_in: "Accedi",
  sign_up: "Registrati",
  signin_error: "L'utente non esiste",
  signup_error:
    "C'è stato un errore durante la registrazione. Si prega di inviare questo errore a " +
    admin_email +
  ...
  crypto_donation_text:
    "Si prega di inviare la tua donazione in criptovaluta ai seguenti indirizzi. Una volta inviata la donazione, potrebbe richiedere del tempo per essere confermata sulla rete blockchain.",
  paypal_donation_title: "Dona tramite PayPal",
  paypal_donation_text:
    "Si prega di utilizzare i seguenti link per effettuare una donazione tramite PayPal. Una volta completata la donazione, potrebbe richiedere del tempo per essere elaborata.",
  bank_donation_title: "Dona tramite Bonifico Bancario",
  bank_donation_text:
    "Si prega di inviare la tua donazione al seguente conto bancario. Una volta trasferita la donazione, potrebbe richiedere del tempo per essere riflessa sul conto.",
  ...
  forgot_password_text:
    "Inserisci l'indirizzo email utilizzato per la registrazione. Ti invieremo la tua nuova password a quell'indirizzo.",
  send: "Invia",
  ...
  empty_input_agree:
    "Non hai accettato i Termini e condizioni e la Politica sulla privacy",
  ...
  error_charge:
    "Ci scusiamo, ma non possiamo addebitarti a causa di un errore da parte nostra. Ripareremo questo errore il prima possibile.",
  ...
  // Keno
  keno_instructions:
    "Seleziona fino a 10 punti Keno o scegli Selezione Veloce (verranno scelti casualmente massimo 10 punti Keno per te)",
