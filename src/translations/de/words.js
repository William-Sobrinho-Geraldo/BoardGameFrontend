...
var word_bank = {
  ...
  no_career:
    "Keine Stellen verfügbar. Aber senden Sie uns gerne Ihren Lebenslauf.",

  cookies_modal_title: "Cookie-Benachrichtigung",
  cookies_modal_text:
    "Um Ihnen die relevantesten Informationen und eine optimale Systemleistung bieten zu können, verwenden wir Cookies, die Informationen über Ihre Spielaktivitäten sammeln.",

  sign_in: "Anmelden",
  sign_up: "Registrieren",
  signin_error: "Der Benutzer existiert nicht",
  signup_error:
    "Es gab einen Fehler bei der Anmeldung. Bitte senden Sie diese Fehlermeldung an " +
    admin_email +
  ...
  crypto_donation_text:
    "Bitte senden Sie Ihre Kryptowährungsspende an die folgenden Adressen. Sobald die Spende gesendet wurde, kann es einige Zeit dauern, bis sie im Blockchain-Netzwerk bestätigt wird.",
  paypal_donation_title: "Spenden via PayPal",
  paypal_donation_text:
    "Bitte verwenden Sie die folgenden Links, um eine Spende über PayPal zu tätigen. Sobald die Spende abgeschlossen ist, kann es einige Zeit dauern, bis sie verarbeitet wird.",
  bank_donation_title: "Spenden via Banküberweisung",
  bank_donation_text:
    "Bitte senden Sie Ihre Spende auf das folgende Bankkonto. Sobald die Spende überwiesen wurde, kann es einige Zeit dauern, bis sie im Konto angezeigt wird.",
  ...
  no_jobs:
    "Noch keine Stellen verfügbar. Aber senden Sie uns gerne Ihren Lebenslauf.",
  ...
  forgot_password_text:
    "Bitte gib die E-Mail-Adresse ein, mit der du dich registriert hast. Wir senden dir dein neues Passwort an diese Adresse.",
  send: "Senden",
  email_send_mailtrap:
    "Die E-Mail wurde gesendet. Überprüfen Sie Ihr Mailtrap-Konto.",
  ...
  empty_input_agree:
    "Sie haben den Geschäftsbedingungen und der Datenschutzrichtlinie nicht zugestimmt",
  ...
  buy: "Kaufen",
  play: "Spielen",
  whack_a_rabbit_popup:
    "Spiele Whack a Rabbit, um kostenlose Karotten zu bekommen!",
  ...
  error_charge:
    "Es tut uns leid, aber wir können dich aufgrund eines Fehlers deinerseits nicht belasten. Wir werden diesen Fehler so schnell wie möglich beheben.",
  ...
  // Keno
  keno_instructions:
    "Wähle bis zu 10 Keno-Spots oder wähle Schnellauswahl (es werden maximal 10 Keno-Spots für dich zufällig ausgewählt)",
  ...
  theme_blue: "Blaues Thema",
  theme_yellow: "Gelbes Thema",
  theme_red_light: "Hellrotes Thema",
  theme_red_dark: "Dunkelrotes Thema",
  //401
  page_not_found_text:
    "Entschuldigung, die von Ihnen gesuchte Seite existiert nicht. Möglicherweise wurde sie verschoben oder gelöscht, oder Sie haben die URL falsch eingegeben.",
};
