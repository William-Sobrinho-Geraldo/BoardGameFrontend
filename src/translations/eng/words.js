...
var word_bank = {
  ...
  cookies_modal_text:
    "In order to offer you the most relevant information and for optimal system performance, we use cookies that collect information from your game activity.",

  sign_in: "Sign in",
  sign_up: "Sign up",
  signin_error: "The user doesn't exist",
  signup_error:
    "There has been an error signing you up. Please email this error to " +
    admin_email +
    " or try again later.",
  ...
  crypto_donation_text:
    "Please send your cryptocurrency donation to the following addresses. Once the donation is sent, it may take some time to confirm on the blockchain network.",
  paypal_donation_title: "Donate via Paypal",
  paypal_donation_text:
    "Please use the following links to make a donation via PayPal. Once the donation is completed, it may take some time to process.",
  bank_donation_title: "Donate via Bank Transfer",
  bank_donation_text:
    "Please send your donation to the following bank account. Once the donation is transferred, it may take some time to reflect in the account.",
  ...
  forgot_password_text:
    "Please enter the email address used to register. We will send you your new password to that address.",
  send: "Send",
  ...
  empty_input_agree:
    "You didn't agree with the Terms and contitions and the Policy privacy",
  ...
  error_charge:
    "We are sorry, but we can't charge you due to an error on our behalf. We will repair this error as soon as possible.",
  ...
  not_enough_money_withdrawal:
    "You don't have enough money to make a withdrawal.",
  ...
  // Keno
  keno_instructions:
    "Pick up to 10 Keno Spots or choose Quick Pick (it will randomly choose max. 10 Keno Spots for you)",
