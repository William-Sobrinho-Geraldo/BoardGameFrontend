  ...
  useEffect(() => {
    const handleSignInRead = (data) => {
      ...
      if (data && data.exists && data.obj && Object.keys(data.obj).length > 0) {
        ...
        if (
          typeof data.obj.logs !== "undefined" &&
          data.obj.logs !== "null" &&
          data.obj.logs !== null &&
          data.obj.logs === 0
        ) {
                ...
                {loaded ? (
                  <>
                    ...
                    >
                      ...
                      <Theme
                        title={translate({ lang: lang, info: "theme_toggle" })}
                        lang={lang}
                      />
                    </div>
                    ...
                    <div className="sign_footer">
                      <h6>
                        Copyright © <span id="copyright_year">{date}</span>{" "}
                        {translate({ lang: lang, info: "all_rights_reserved" })}
                        .
                      </h6>
                    </div>
                  </>
